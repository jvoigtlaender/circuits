...
Elm.Basics = Elm.Basics || {};
Elm.Basics.Extra = Elm.Basics.Extra || {};
Elm.Basics.Extra.make = function (_elm) {
   "use strict";
   _elm.Basics = _elm.Basics || {};
   _elm.Basics.Extra = _elm.Basics.Extra || {};
   if (_elm.Basics.Extra.values) return _elm.Basics.Extra.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var swap = function (_p0) {    var _p1 = _p0;return {ctor: "_Tuple2",_0: _p1._1,_1: _p1._0};};
   return _elm.Basics.Extra.values = {_op: _op,swap: swap};
};
Elm.Native.Json = {};
...
Elm.Matrix.make = function (_elm) {
   ...
   var set = F4(function (i,j,v,matrix) {
      ...
      return _U.cmp(i,width(matrix)) < 0 && _U.cmp(i,-1) > 0 && (_U.cmp(j,height(matrix)) < 0 && _U.cmp(j,-1) > 0) ? _U.update(matrix,
...
Elm.Ratio.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var toFloat = function (_p0) {    var _p1 = _p0;return $Basics.toFloat(_p1._0) / $Basics.toFloat(_p1._1);};
   var split = function (_p2) {    var _p3 = _p2;return {ctor: "_Tuple2",_0: _p3._0,_1: _p3._1};};
   var denominator = function (_p4) {    var _p5 = _p4;return _p5._1;};
   var numerator = function (_p6) {    var _p7 = _p6;return _p7._0;};
   ...
   var Ratio = F2(function (a,b) {    return {ctor: "Ratio",_0: a,_1: b};});
   ...
   var add = F2(function (_p13,_p12) {
      ...
      var _p15 = _p12;
      var _p16 = _p15._1;
      return normalize(A2(Ratio,_p14._0 * _p16 + _p17 * _p15._0,_p17 * _p16));
   });
   var multiply = F2(function (_p19,_p18) {    var _p20 = _p19;var _p21 = _p18;return normalize(A2(Ratio,_p20._0 * _p21._0,_p20._1 * _p21._1));});
   var divide = F2(function (r,_p22) {    var _p23 = _p22;return A2(multiply,r,A2(Ratio,_p23._1,_p23._0));});
   var negate = function (_p24) {    var _p25 = _p24;return A2(Ratio,0 - _p25._0,_p25._1);};
   var over = F2(function (x,y) {    return normalize(A2(Ratio,x,y));});
...
Elm.Types.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var Tile = F5(function (a,b,c,d,e) {    return {component: a,orientation: b,pos: c,status: d,toToggle: e};});
   var Component = F3(function (a,b,c) {    return {logic: a,innards: b,viewInfo: c};});
   var ViewInfo = F5(function (a,b,c,d,e) {    return {width: a,height: b,plateWidth: c,plateHeight: d,ports: e};});
   var PortInfo = F2(function (a,b) {    return {orientation: a,spans: b};});
   var Active = function (a) {    return {ctor: "Active",_0: a};};
   var Passive = {ctor: "Passive"};
   var Dynamic = function (a) {    return {ctor: "Dynamic",_0: a};};
   var Static = function (a) {    return {ctor: "Static",_0: a};};
   var Switcher = function (a) {    return {ctor: "Switcher",_0: a};};
   var Contactor = function (a) {    return {ctor: "Contactor",_0: a};};
   var Lamp = {ctor: "Lamp"};
   var Power = {ctor: "Power"};
   var dummyComponent = A3(Component,Static(Power),Static($Graphics$Collage.group(_U.list([]))),A5(ViewInfo,0,0,0,0,_U.list([])));
...
Elm.Catalog = Elm.Catalog || {};
Elm.Catalog.make = function (_elm) {
   "use strict";
   _elm.Catalog = _elm.Catalog || {};
   if (_elm.Catalog.values) return _elm.Catalog.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var switcher = function () {
      var baseForm = $Graphics$Collage.group(_U.list([A2($Graphics$Collage.traced,
                                                     _U.update($Graphics$Collage.defaultLine,{width: 2}),
                                                     $Graphics$Collage.path(_U.list([{ctor: "_Tuple2",_0: 18,_1: 20},{ctor: "_Tuple2",_0: 18,_1: 46}])))
                                                     ,A2($Graphics$Collage.move,
                                                     {ctor: "_Tuple2",_0: 18,_1: 20},
                                                     A2($Graphics$Collage.filled,$Color.black,$Graphics$Collage.circle(4)))
                                                     ...
                                                     ,A2($Graphics$Collage.traced,
                                                     _U.update($Graphics$Collage.defaultLine,{width: 2}),
                                                     $Graphics$Collage.path(_U.list([{ctor: "_Tuple2",_0: -20,_1: 0},{ctor: "_Tuple2",_0: -46,_1: 0}])))
                                                     ,A2($Graphics$Collage.move,
                                                     {ctor: "_Tuple2",_0: -20,_1: 0},
                                                     A2($Graphics$Collage.filled,$Color.black,$Graphics$Collage.circle(4)))]));
      var offForm = $Graphics$Collage.group(_U.list([A2($Graphics$Collage.traced,
                                                    _U.update($Graphics$Collage.defaultLine,{width: 2}),
                                                    $Graphics$Collage.path(_U.list([{ctor: "_Tuple2",_0: -20,_1: 0},{ctor: "_Tuple2",_0: 18,_1: 20}])))
                                                    ,baseForm]));
      var onForm = $Graphics$Collage.group(_U.list([A2($Graphics$Collage.traced,
                                                   _U.update($Graphics$Collage.defaultLine,{width: 2}),
                                                   $Graphics$Collage.path(_U.list([{ctor: "_Tuple2",_0: -20,_1: 0},{ctor: "_Tuple2",_0: 18,_1: -20}])))
                                                   ,baseForm]));
      return A3($Types.Component,
      $Types.Dynamic($Types.Switcher),
      $Types.Dynamic(function (b) {    return b ? onForm : offForm;}),
      A5($Types.ViewInfo,
      46,
      46,
      36,
      36,
      _U.list([{ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: 18,_1: 46},_1: {orientation: 1,spans: {left: 75,right: 48}}}
              ,{ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: 18,_1: -46},_1: {orientation: 3,spans: {left: 39,right: 84}}}
              ,{ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: -46,_1: 0},_1: {orientation: 2,spans: {left: 57,right: 66}}}])));
   }();
   var contactor = function () {
      var baseForm = $Graphics$Collage.group(_U.list([A2($Graphics$Collage.traced,
                                                     _U.update($Graphics$Collage.defaultLine,{width: 2}),
                                                     $Graphics$Collage.path(_U.list([{ctor: "_Tuple2",_0: 20,_1: -6},{ctor: "_Tuple2",_0: 49,_1: -6}])))
                                                     ,A2($Graphics$Collage.move,
                                                     {ctor: "_Tuple2",_0: 20,_1: -6},
                                                     A2($Graphics$Collage.filled,$Color.black,$Graphics$Collage.circle(4)))
                                                     ,A2($Graphics$Collage.traced,
                                                     _U.update($Graphics$Collage.defaultLine,{width: 2}),
                                                     $Graphics$Collage.path(_U.list([{ctor: "_Tuple2",_0: -20,_1: -6},{ctor: "_Tuple2",_0: -49,_1: -6}])))
      ...
      var offForm = $Graphics$Collage.group(_U.list([A2($Graphics$Collage.traced,
                                                    _U.update($Graphics$Collage.defaultLine,{width: 2}),
                                                    $Graphics$Collage.path(_U.list([{ctor: "_Tuple2",_0: -20,_1: -6}
                                                                                   ,{ctor: "_Tuple2",_0: -20 + 40 * $Basics.sqrt(3 / 4),_1: 14}])))
                                                    ,baseForm]));
      var onForm = $Graphics$Collage.group(_U.list([A2($Graphics$Collage.traced,
                                                   _U.update($Graphics$Collage.defaultLine,{width: 2}),
                                                   $Graphics$Collage.path(_U.list([{ctor: "_Tuple2",_0: -20,_1: -6},{ctor: "_Tuple2",_0: 20,_1: -6}])))
                                                   ,baseForm]));
      return A3($Types.Component,
      $Types.Dynamic($Types.Contactor),
      $Types.Dynamic(function (b) {    return b ? onForm : offForm;}),
      A5($Types.ViewInfo,
      49,
      29,
      39,
      29,
      _U.list([{ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: 49,_1: -6},_1: {orientation: 0,spans: {left: 54,right: 51}}}
              ,{ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: -49,_1: -6},_1: {orientation: 2,spans: {left: 42,right: 63}}}])));
   }();
   var lamp = function () {
      var d = 20 * $Basics.sqrt(1 / 2);
      var offForm = $Graphics$Collage.group(_U.list([A2($Graphics$Collage.outlined,
                                                    _U.update($Graphics$Collage.defaultLine,{width: 2}),
                                                    $Graphics$Collage.circle(20))
                                                    ,A2($Graphics$Collage.traced,
                                                    _U.update($Graphics$Collage.defaultLine,{width: 2}),
                                                    $Graphics$Collage.path(_U.list([{ctor: "_Tuple2",_0: 0 - d,_1: 0 - d},{ctor: "_Tuple2",_0: d,_1: d}])))
                                                    ,A2($Graphics$Collage.traced,
                                                    _U.update($Graphics$Collage.defaultLine,{width: 2}),
                                                    $Graphics$Collage.path(_U.list([{ctor: "_Tuple2",_0: 0 - d,_1: d},{ctor: "_Tuple2",_0: d,_1: 0 - d}])))
                                                    ,A2($Graphics$Collage.traced,
                                                    _U.update($Graphics$Collage.defaultLine,{width: 2}),
                                                    $Graphics$Collage.path(_U.list([{ctor: "_Tuple2",_0: 20,_1: 0},{ctor: "_Tuple2",_0: 51,_1: 0}])))
                                                    ,A2($Graphics$Collage.traced,
                                                    _U.update($Graphics$Collage.defaultLine,{width: 2}),
                                                    $Graphics$Collage.path(_U.list([{ctor: "_Tuple2",_0: -20,_1: 0},{ctor: "_Tuple2",_0: -51,_1: 0}])))]));
      var onForm = $Graphics$Collage.group(_U.list([A2($Graphics$Collage.filled,$Color.yellow,$Graphics$Collage.circle(20)),offForm]));
      return A3($Types.Component,
      $Types.Static($Types.Lamp),
      $Types.Dynamic(function (b) {    return b ? onForm : offForm;}),
      A5($Types.ViewInfo,
      51,
      31,
      41,
      31,
      _U.list([{ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: 51,_1: 0},_1: {orientation: 0,spans: {left: 51,right: 60}}}
              ,{ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: -51,_1: 0},_1: {orientation: 2,spans: {left: 51,right: 60}}}])));
   }();
   var power = A3($Types.Component,
   $Types.Static($Types.Power),
   $Types.Static($Graphics$Collage.group(_U.list([A2($Graphics$Collage.traced,
                                                 _U.update($Graphics$Collage.defaultLine,{width: 2}),
                                                 $Graphics$Collage.path(_U.list([{ctor: "_Tuple2",_0: 4,_1: 0},{ctor: "_Tuple2",_0: 40,_1: 0}])))
                                                 ,A2($Graphics$Collage.traced,
                                                 _U.update($Graphics$Collage.defaultLine,{width: 3}),
                                                 $Graphics$Collage.path(_U.list([{ctor: "_Tuple2",_0: 4,_1: -20},{ctor: "_Tuple2",_0: 4,_1: 20}])))
                                                 ,A2($Graphics$Collage.traced,
                                                 _U.update($Graphics$Collage.defaultLine,{width: 2}),
                                                 $Graphics$Collage.path(_U.list([{ctor: "_Tuple2",_0: -4,_1: 0},{ctor: "_Tuple2",_0: -40,_1: 0}])))
                                                 ,A2($Graphics$Collage.traced,
                                                 _U.update($Graphics$Collage.defaultLine,{width: 6}),
                                                 $Graphics$Collage.path(_U.list([{ctor: "_Tuple2",_0: -4,_1: -12},{ctor: "_Tuple2",_0: -4,_1: 12}])))]))),
   A5($Types.ViewInfo,
   40,
   30,
   30,
   30,
   _U.list([{ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: 40,_1: 0},_1: {orientation: 0,spans: {left: 51,right: 60}}}
           ,{ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: -40,_1: 0},_1: {orientation: 2,spans: {left: 51,right: 60}}}])));
   var catalog = _U.list([{ctor: "_Tuple3",_0: power,_1: $Types.Passive,_2: $Maybe.Nothing}
                         ,{ctor: "_Tuple3",_0: lamp,_1: $Types.Active(false),_2: $Maybe.Nothing}
                         ,{ctor: "_Tuple3",_0: contactor,_1: $Types.Active(false),_2: $Maybe.Just(false)}
                         ,{ctor: "_Tuple3",_0: switcher,_1: $Types.Active(false),_2: $Maybe.Just(true)}]);
   var portSize = 4;
   var portDistance = 16;
   var grid = 6;
   return _elm.Catalog.values = {_op: _op,catalog: catalog,grid: grid,portDistance: portDistance,portSize: portSize};
};
...
Elm.Inputs.make = function (_elm) {
   ...
   $Types = Elm.Types.make(_elm);
   var _op = {};
   var keyAutomaton = function () {
      var step = F2(function (newSet,oldSet) {
         return A3($Basics.flip,
         F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),
         newSet,
         function () {
            var _p0 = $Set.toList(A2($Set.diff,newSet,oldSet));
            if (_p0.ctor === "::") {
                  if (_p0._1.ctor === "[]") {
                        return $Maybe.Just({ctor: "_Tuple2",_0: _p0._0,_1: true});
                     } else {
                        return _U.crashCase("Inputs",{start: {line: 26,column: 17},end: {line: 39,column: 50}},_p0)("IMPOSSIBLE!");
                     }
               } else {
                  var _p1 = $Set.toList(A2($Set.diff,oldSet,newSet));
                  if (_p1.ctor === "::" && _p1._1.ctor === "[]") {
                        return $Maybe.Just({ctor: "_Tuple2",_0: _p1._0,_1: false});
                     } else {
                        return $Maybe.Nothing;
                     }
               }
      ...
      return A2($Automaton.hiddenState,$Set.empty,step);
   }();
   var toggling = A3($Signal.filterMap,
   A2($Maybe$Extra.mapDefault,
   $Maybe.Nothing,
   function (_p3) {
      var _p4 = _p3;
      var _p6 = _p4._0;
      var _p5 = _p4._1;
      return _U.cmp(47,_p6) < 0 && _U.cmp(_p6,58) < 0 ? $Maybe.Just({ctor: "_Tuple2",_0: _p6 - 48,_1: _p5}) : _U.cmp(64,_p6) < 0 && _U.cmp(_p6,
      91) < 0 ? $Maybe.Just({ctor: "_Tuple2",_0: _p6 - 55,_1: _p5}) : $Maybe.Nothing;
   }),
   {ctor: "_Tuple2",_0: 0,_1: false},
   A3($Automaton.run,keyAutomaton,$Maybe.Nothing,$Keyboard.keysDown));
   var hover = $Signal.mailbox($Maybe.Nothing);
   var create = $Signal.mailbox({ctor: "_Tuple4",_0: $Types.dummyComponent,_1: $Types.Passive,_2: {ctor: "_Tuple2",_0: 0,_1: 0},_3: $Maybe.Nothing});
   return _elm.Inputs.values = {_op: _op,create: create,hover: hover,toggling: toggling};
};
Elm.Pictures = Elm.Pictures || {};
Elm.Pictures.make = function (_elm) {
   "use strict";
   _elm.Pictures = _elm.Pictures || {};
   if (_elm.Pictures.values) return _elm.Pictures.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Graphics$Collage = Elm.Graphics.Collage.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var picturesToForms = function (_p0) {    var _p1 = _p0;return A2($Basics._op["++"],_p1._0,_p1._1);};
   var Pictures = F2(function (a,b) {    return {ctor: "Pictures",_0: a,_1: b};});
   var move = F2(function (by,_p2) {
      var _p3 = _p2;
      return A2(Pictures,A2($List.map,$Graphics$Collage.move(by),_p3._0),A2($List.map,$Graphics$Collage.move(by),_p3._1));
   });
   var rotate = F2(function (by,_p4) {
      var _p5 = _p4;
      return A2(Pictures,A2($List.map,$Graphics$Collage.rotate(by),_p5._0),A2($List.map,$Graphics$Collage.rotate(by),_p5._1));
   });
   var empty = A2(Pictures,_U.list([]),_U.list([]));
   var without = F2(function (a,_p6) {    var _p7 = _p6;return A2(Pictures,A2($Basics._op["++"],a,_p7._0),_p7._1);});
   var $with = F2(function (a,_p8) {    var _p9 = _p8;return A2(Pictures,_p9._0,A2($Basics._op["++"],a,_p9._1));});
   var join = F2(function (_p11,_p10) {
      var _p12 = _p11;
      var _p13 = _p10;
      return A2(Pictures,A2($Basics._op["++"],_p12._0,_p13._0),A2($Basics._op["++"],_p12._1,_p13._1));
   });
   return _elm.Pictures.values = {_op: _op,empty: empty,join: join,move: move,picturesToForms: picturesToForms,rotate: rotate,$with: $with,without: without};
};
Elm.Util = Elm.Util || {};
Elm.Util.make = function (_elm) {
   ...
   $Types = Elm.Types.make(_elm);
   var _op = {};
   var applyStatus = F2(function (switchable,status) {
      var _p0 = {ctor: "_Tuple2",_0: switchable,_1: status};
      _v0_2: do {
         if (_p0.ctor === "_Tuple2") {
               if (_p0._0.ctor === "Static") {
                     return _p0._0._0;
                  } else {
                     if (_p0._1.ctor === "Active") {
                           return _p0._0._0(_p0._1._0);
                        } else {
                           break _v0_2;
                        }
                  }
      ...
      return _U.crashCase("Util",{start: {line: 48,column: 5},end: {line: 56,column: 38}},_p0)("IMPOSSIBLE!");
   });
   var switchStatus = function (status) {
      var _p2 = status;
      if (_p2.ctor === "Active") {
            return $Types.Active($Basics.not(_p2._0));
         } else {
            return _U.crashCase("Util",{start: {line: 39,column: 5},end: {line: 44,column: 38}},_p2)("IMPOSSIBLE!");
         }
   };
   var isConnected = function (id) {    return $List.any(function (_p4) {    var _p5 = _p4;return _U.eq(_p5._0._0,id) || _U.eq(_p5._1._0,id);});};
   var snap = function (z) {    return $Basics.toFloat($Basics.round(z / $Catalog.grid) * $Catalog.grid);};
   var rotate = F2(function (n,_p6) {
      var _p7 = _p6;
      var _p10 = _p7._1;
      var _p9 = _p7._0;
      var _p8 = n;
      switch (_p8)
      {case 1: return {ctor: "_Tuple2",_0: 0 - _p10,_1: _p9};
         case 2: return {ctor: "_Tuple2",_0: 0 - _p9,_1: 0 - _p10};
         case 3: return {ctor: "_Tuple2",_0: _p10,_1: 0 - _p9};
         default: return {ctor: "_Tuple2",_0: _p9,_1: _p10};}
   });
   var plus = F2(function (_p12,_p11) {    var _p13 = _p12;var _p14 = _p11;return {ctor: "_Tuple2",_0: _p13._0 + _p14._0,_1: _p13._1 + _p14._1};});
   var minus = F2(function (_p16,_p15) {    var _p17 = _p16;var _p18 = _p15;return {ctor: "_Tuple2",_0: _p17._0 - _p18._0,_1: _p17._1 - _p18._1};});
...
Elm.Draw.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Pictures = Elm.Pictures.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm),
   $Text = Elm.Text.make(_elm),
   ...
   var _op = {};
   var drawEncircling = A2($Graphics$Collage.outlined,_U.update($Graphics$Collage.defaultLine,{width: 2}),$Graphics$Collage.circle($Catalog.portSize + 4));
   var drawPort = A2($Graphics$Collage.filled,$Color.black,$Graphics$Collage.circle($Catalog.portSize));
   var drawPlate = F2(function (x,y) {
      return A3($Graphics$Collage.collage,
      2 * x,
      2 * y,
      _U.list([A2($Graphics$Collage.outlined,_U.update($Graphics$Collage.defaultLine,{width: 4}),A2($Graphics$Collage.rect,2 * x,2 * y))]));
   });
   var makeGround = F2(function (xExtent,yExtent) {
      var pad = 20;
      var xOff = pad + A2($Maybe.withDefault,
      0,
      $List.maximum(A2($List.map,
      function (_p0) {
         return function (_) {
            return _.width;
         }(function (_) {    return _.viewInfo;}(function (_p1) {    var _p2 = _p1;return _p2._0;}(_p0)));
      },
      $Catalog.catalog)));
      var xRight = xExtent - 2 * xOff;
      return {ctor: "_Tuple2"
             ,_0: _U.list([A2($Graphics$Collage.move,
             {ctor: "_Tuple2",_0: 0 - xOff,_1: 0},
             A2($Graphics$Collage.filled,$Color.red,A2($Graphics$Collage.rect,xExtent + xRight,2 * yExtent)))])
             ,_1: A2($Pictures.without,
             _U.list([A2($Graphics$Collage.outlined,_U.update($Graphics$Collage.defaultLine,{width: 4}),A2($Graphics$Collage.rect,2 * xExtent,2 * yExtent))
                     ,A2($Graphics$Collage.traced,
                     _U.update($Graphics$Collage.defaultLine,{width: 2}),
                     $Graphics$Collage.path(_U.list([{ctor: "_Tuple2",_0: xRight,_1: 0 - yExtent},{ctor: "_Tuple2",_0: xRight,_1: yExtent}])))]),
             $Basics.fst(A3($List.foldl,
             F2(function (_p4,_p3) {
                var _p5 = _p4;
                var _p11 = _p5._1;
                var _p10 = _p5._0;
                var _p6 = _p3;
                var _p9 = _p6._1;
                var innerForm = A2($Util.applyStatus,_p10.innards,_p11);
                var _p7 = _p10.viewInfo;
                var height = _p7.height;
                var plateWidth = _p7.plateWidth;
                var plateHeight = _p7.plateHeight;
                var ports = _p7.ports;
                var plateForm = $Graphics$Collage.toForm(A2($Graphics$Input.clickable,
                A2($Signal.message,
                $Inputs.create.address,
                {ctor: "_Tuple4",_0: _p10,_1: _p11,_2: {ctor: "_Tuple2",_0: xRight - xOff,_1: _p9 - height},_3: _p5._2}),
                A2(drawPlate,plateWidth,plateHeight)));
                return {ctor: "_Tuple2"
                       ,_0: A2($Pictures.join,
                       _p6._0,
                       A2($Pictures.move,
                       {ctor: "_Tuple2",_0: xExtent - xOff,_1: _p9 - height},
                       A2($Pictures.without,
                       A2($List.map,function (_p8) {    return A3($Basics.flip,$Graphics$Collage.move,drawPort,$Basics.fst(_p8));},ports),
                       A2($Pictures.without,_U.list([innerForm]),A2($Pictures.$with,_U.list([plateForm]),$Pictures.empty)))))
                       ,_1: _p9 - 2 * height - pad};
             }),
             {ctor: "_Tuple2",_0: $Pictures.empty,_1: yExtent - pad},
             $Catalog.catalog)))};
   });
   var tile = F4(function (turnAddress,connectAddress,_p13,_p12) {
      var _p14 = _p13;
      var _p15 = _p12;
      var _p28 = _p15._1.pos;
      var _p27 = _p15._1.orientation;
      var _p26 = _p15._0;
      var _p25 = _p15._1.component;
      var nearMouse = function (_p16) {
         var _p17 = _p16;
         return _U.cmp($Basics.abs(_p14._0 - _p17._0),$Catalog.portSize) < 0 && _U.cmp($Basics.abs(_p14._1 - _p17._1),$Catalog.portSize) < 0;
      };
      var portForm = function (id) {
         return $Graphics$Collage.toForm(A2($Graphics$Input.clickable,
         A2($Signal.message,connectAddress,id),
         A3($Graphics$Collage.collage,2 * $Catalog.portSize,2 * $Catalog.portSize,_U.list([drawPort]))));
      };
      var innerForm = A2($Util.applyStatus,_p25.innards,_p15._1.status);
      var _p18 = _p25.viewInfo;
      var plateWidth = _p18.plateWidth;
      var plateHeight = _p18.plateHeight;
      var ports = _p18.ports;
      var plateForm = $Graphics$Collage.toForm(A2($Graphics$Input.hoverable,
      function (_p19) {
         return A2($Signal.message,$Inputs.hover.address,function (h) {    return h ? $Maybe.Just(_p26) : $Maybe.Nothing;}(_p19));
      },
      A2($Graphics$Input.clickable,A2($Signal.message,turnAddress,_p26),A2(drawPlate,plateWidth,plateHeight))));
      var portsToDraw = A2($List.map,function (_p20) {    return A2($Util.plus,_p28,A2($Util.rotate,_p27,$Basics.fst(_p20)));},ports);
      return A2($Pictures.without,
      A2($List.filterMap,function (pos) {    return nearMouse(pos) ? $Maybe.Just(A2($Graphics$Collage.move,pos,drawEncircling)) : $Maybe.Nothing;},portsToDraw),
      A2($Pictures.$with,
      A2($List.indexedMap,
      function (_p21) {
         return A2($Basics.flip,$Graphics$Collage.move,portForm(A2(F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),_p26,_p21)));
      },
      portsToDraw),
      A2($Pictures.move,
      _p28,
      function () {
         var _p22 = _p15._1.toToggle;
         if (_p22.ctor === "Nothing") {
               return $Basics.identity;
            } else {
               var _p24 = _p22._0;
               var _p23 = _U.eq(A2($Basics._op["%"],_p27,2),0) ? {ctor: "_Tuple2",_0: 0 - plateWidth,_1: plateHeight} : {ctor: "_Tuple2"
                                                                                                                        ,_0: 0 - plateHeight
                                                                                                                        ,_1: plateWidth};
               var cx = _p23._0;
               var cy = _p23._1;
               return $Pictures.without(_U.list([A2($Graphics$Collage.move,
               {ctor: "_Tuple2",_0: $Basics.toFloat(cx) + 7,_1: $Basics.toFloat(cy) - 7},
               $Graphics$Collage.text($Text.fromString(A3($String.slice,_p24,_p24 + 1,"0123456789abcdefghijklmnopqrstuvwxyz"))))]));
            }
      }()(A2($Pictures.rotate,
      $Basics.toFloat(_p27) * $Basics.pi / 2,
      A2($Pictures.without,_U.list([innerForm]),A2($Pictures.$with,_U.list([plateForm]),$Pictures.empty)))))));
   });
   return _elm.Draw.values = {_op: _op,makeGround: makeGround,tile: tile};
};
Elm.Logic = Elm.Logic || {};
Elm.Logic.make = function (_elm) {
   ...
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Basics$Extra = Elm.Basics.Extra.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Types = Elm.Types.make(_elm);
   var _op = {};
   var one = $Ratio.fromInt(1);
   var zero = $Ratio.fromInt(0);
   var safeGet = F3(function (i,j,m) {
      var _p0 = A3($Matrix.get,i,j,m);
      if (_p0.ctor === "Nothing") {
            return _U.crashCase("Logic",{start: {line: 286,column: 5},end: {line: 291,column: 14}},_p0)("IMPOSSIBLE!");
         } else {
            return _p0._0;
         }
   });
   var gaussJordan = function (n) {
      var backward = F2(function (i,m) {
         return _U.eq($Ratio.numerator(A3(safeGet,i,i,m)),0) ? m : A3($List.foldl,
         function (r) {
            var k = $Ratio.negate(A3(safeGet,i,r,m));
            return function (_p2) {
               return A3($Basics.flip,
               $List.foldl(function (c) {    return A3($Matrix.update,c,r,$Ratio.add(A2($Ratio.multiply,k,A3(safeGet,c,i,m))));}),
               _U.range(i + 1,n),
               A4($Matrix.set,i,r,zero,_p2));
            };
         },
         m,
         _U.range(0,i - 1));
      });
      var swapIfNecessary = F3(function (i,j,m) {
         return _U.eq(i,j) ? m : A3($List.foldl,
         function (c) {
            return function (_p3) {
               return A4($Matrix.set,c,i,A3(safeGet,c,j,m),A4($Matrix.set,c,j,A3(safeGet,c,i,m),_p3));
            };
         },
         m,
         _U.range(i,n));
      });
      var forward = F2(function (i,m) {
         var _p4 = A2($Matrix.getColumn,i,m);
         if (_p4.ctor === "Nothing") {
               return _U.crashCase("Logic",{start: {line: 238,column: 13},end: {line: 264,column: 51}},_p4)("IMPOSSIBLE!");
            } else {
               var _p8 = A2($List$Extra.find,
               function (_p6) {
                  var _p7 = _p6;
                  return !_U.eq($Ratio.numerator(_p7._1),0);
               },
               A2($List.drop,i,$Array.toIndexedList(_p4._0)));
               if (_p8.ctor === "Nothing") {
                     return m;
                  } else {
                     var m$ = A3($Basics.flip,
                     $List.foldl(function (c) {    return A3($Matrix.update,c,i,A2($Basics.flip,$Ratio.divide,_p8._0._1));}),
                     _U.range(i + 1,n),
                     A4($Matrix.set,i,i,one,A3(swapIfNecessary,i,_p8._0._0,m)));
                     return A3($List.foldl,
                     function (r) {
                        var f = $Ratio.negate(A3(safeGet,i,r,m$));
                        return function (_p9) {
                           return A3($Basics.flip,
                           $List.foldl(function (c) {    return A3($Matrix.update,c,r,$Ratio.add(A2($Ratio.multiply,f,A3(safeGet,c,i,m$))));}),
                           _U.range(i + 1,n),
                           A4($Matrix.set,i,r,zero,_p9));
                        };
                     },
                     m$,
                     _U.range(i + 1,n - 1));
      ...
      return function (_p10) {
         return A3($Basics.flip,$List.foldl(backward),$List.reverse(_U.range(1,n - 1)),A3($Basics.flip,$List.foldl(forward),_U.range(0,n - 1),_p10));
      };
   };
   var onLamps = F4(function (lamps,powers,connections,allPorts) {
      var symmetrize = $List.concatMap(function (_p11) {
         var _p12 = _p11;
         var _p14 = _p12._1;
         var _p13 = _p12._0;
         return _U.list([{ctor: "_Tuple2",_0: _p13,_1: _p14},{ctor: "_Tuple2",_0: _p14,_1: _p13}]);
      });
      var pick = F2(function (pred,list) {
         var _p15 = list;
         if (_p15.ctor === "[]") {
               return _U.crashCase("Logic",{start: {line: 119,column: 13},end: {line: 131,column: 53}},_p15)("IMPOSSIBLE!");
            } else {
               var _p19 = _p15._1;
               var _p18 = _p15._0;
               if (pred(_p18)) return {ctor: "_Tuple2",_0: _p18,_1: _p19}; else {
                     var _p17 = A2(pick,pred,_p19);
                     var picked = _p17._0;
                     var rest = _p17._1;
                     return {ctor: "_Tuple2",_0: picked,_1: A2($List._op["::"],_p18,rest)};
                  }
            }
      });
      var merge = F2(function (_p20,sets) {
         var _p21 = _p20;
         var _p26 = _p21._1;
         var _p22 = A2(pick,$Set.member(_p21._0),sets);
         var _p25 = _p22._0;
         var _p24 = _p22._1;
         if (A2($Set.member,_p26,_p25)) return A2($List._op["::"],_p25,_p24); else {
               var _p23 = A2(pick,$Set.member(_p26),_p24);
               return A2($List._op["::"],A2($Set.union,_p25,_p23._0),_p23._1);
            }
      });
      var allPorts$ = A3($List.foldl,merge,A2($List.map,$Set.singleton,allPorts),connections);
      var n = $List.length(allPorts$);
      var ground = n - 1;
      var indexing = A3($List.foldl,
      $Basics.uncurry(function (i) {    return $Basics.flip($Set.foldl(A2($Basics.flip,$Dict.insert,i)));}),
      $Dict.empty,
      A2($List.indexedMap,F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),allPorts$));
      var index = function (p) {
         var _p27 = A2($Dict.get,p,indexing);
         if (_p27.ctor === "Nothing") {
               return _U.crashCase("Logic",{start: {line: 153,column: 13},end: {line: 158,column: 22}},_p27)("IMPOSSIBLE!");
            } else {
               return _p27._0;
            }
      };
      var powerPorts = A2($List.map,
      function (_p29) {
         var _p30 = _p29;
         var _p31 = _p30._0;
         return {ctor: "_Tuple2",_0: index({ctor: "_Tuple2",_0: _p31,_1: 0}),_1: index({ctor: "_Tuple2",_0: _p31,_1: 1})};
      },
      powers);
      var vector = A3($List.foldl,
      function (_p32) {
         var _p33 = _p32;
         return function (_p34) {
            ...
            0,
            _p33._1,
            A2($Basics.flip,F2(function (x,y) {    return x - y;}),1),
            A4($Matrix.update,0,_p33._0,F2(function (x,y) {    return x + y;})(1),_p34));
         };
      },
      A3($Matrix.repeat,1,ground,0),
      powerPorts);
      var matrix = A3($List.foldl,
      function (_p35) {
         var _p36 = _p35;
         var _p38 = _p36._0;
         return function (_p37) {
            ...
            _p36._1,
            A2($Basics.flip,F2(function (x,y) {    return x - y;}),1),
            A4($Matrix.update,_p38,_p38,F2(function (x,y) {    return x + y;})(1),_p37));
         };
      },
      A3($Matrix.repeat,ground,ground,0),
      symmetrize(A2($Basics._op["++"],
      powerPorts,
      A2($List.map,
      function (_p39) {
         var _p40 = _p39;
         var _p41 = _p40._0;
         return {ctor: "_Tuple2",_0: index({ctor: "_Tuple2",_0: _p41,_1: 0}),_1: index({ctor: "_Tuple2",_0: _p41,_1: 1})};
      },
      lamps))));
      var solution = A2(gaussJordan,
      ground,
      function () {
         var _p42 = A2($Matrix.concatHorizontal,matrix,vector);
         if (_p42.ctor === "Nothing") {
               return _U.crashCase("Logic",{start: {line: 183,column: 17},end: {line: 188,column: 51}},_p42)("IMPOSSIBLE!");
            } else {
               return A2($Matrix.map,$Ratio.fromInt,_p42._0);
            }
      }());
      var potentials = A2($Maybe.withDefault,$Array.empty,A2($Matrix.getColumn,ground,solution));
      var potential = function (i) {    return _U.eq(i,ground) ? $Maybe.Just(zero) : A2($Array.get,i,potentials);};
      return A2($List.map,
      function (_p44) {
         var _p45 = _p44;
         var _p47 = _p45._0;
         return {ctor: "_Tuple2"
                ,_0: _p47
                ,_1: function () {
                   var _p46 = {ctor: "_Tuple2",_0: potential(index({ctor: "_Tuple2",_0: _p47,_1: 0})),_1: potential(index({ctor: "_Tuple2",_0: _p47,_1: 1}))};
                   if (_p46.ctor === "_Tuple2" && _p46._0.ctor === "Just" && _p46._1.ctor === "Just") {
                         return !_U.eq($Ratio.numerator(A2($Ratio.add,_p46._0._0,$Ratio.negate(_p46._1._0))),0);
                      } else {
                         return false;
                      }
                }()};
   ...
   var connectedIn = F3(function (matrix,i,j) {    return A2($Maybe.withDefault,false,A3($Matrix.get,i,j,matrix));});
   var warshall = F2(function (n,matrix) {
      var step = F2(function (k,matrix) {
         return A2($Matrix.indexedMap,F3(function (i,j,t) {    return t || A3(connectedIn,matrix,i,k) && A3(connectedIn,matrix,k,j);}),matrix);
      });
      return A3($List.foldl,step,matrix,_U.range(0,n - 1));
   });
   var isIllegal = F3(function (powers,connections,connectedPorts) {
      var indexing = $Dict.fromList(A2($List.indexedMap,$Basics.flip(F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};})),connectedPorts));
      var index = function (p) {    return A2($Maybe.withDefault,-1,A2($Dict.get,p,indexing));};
      var powerPorts = A2($List.map,
      function (_p48) {
         var _p49 = _p48;
         var _p50 = _p49._0;
         return {ctor: "_Tuple2",_0: index({ctor: "_Tuple2",_0: _p50,_1: 0}),_1: index({ctor: "_Tuple2",_0: _p50,_1: 1})};
      },
      powers);
      var symmetrize = $List.concatMap(function (_p51) {
         var _p52 = _p51;
         var to$ = index(_p52._1);
         var from$ = index(_p52._0);
         return _U.list([{ctor: "_Tuple2",_0: from$,_1: to$},{ctor: "_Tuple2",_0: to$,_1: from$}]);
      });
      var exceptLamps = A2($Basics._op["++"],powerPorts,symmetrize(connections));
      var n = $List.length(connectedPorts);
      var exceptLampsTransitive = A2(warshall,
      n,
      A3($List.foldl,function (_p53) {    var _p54 = _p53;return A3($Matrix.set,_p54._0,_p54._1,true);},A3($Matrix.repeat,n,n,false),exceptLamps));
      return A2($List.any,$Basics.uncurry(connectedIn(exceptLampsTransitive)),A2($List.map,$Basics$Extra.swap,powerPorts));
   });
   var ports = function (logic) {    var _p55 = logic;if (_p55.ctor === "Switcher") {    return _U.list([0,1,2]);} else {    return _U.list([0,1]);}};
   var inner = function (logic) {
      var _p56 = logic;
      switch (_p56.ctor)
      {case "Contactor": if (_p56._0 === false) {
                 return $Maybe.Nothing;
              } else {
                 return $Maybe.Just({ctor: "_Tuple2",_0: 0,_1: 1});
              }
         case "Switcher": if (_p56._0 === false) {
                 return $Maybe.Just({ctor: "_Tuple2",_0: 0,_1: 2});
              } else {
                 return $Maybe.Just({ctor: "_Tuple2",_0: 1,_1: 2});
              }
         default: return _U.crashCase("Logic",{start: {line: 16,column: 5},end: {line: 30,column: 38}},_p56)("IMPOSSIBLE!");}
   };
   var process = F2(function (tiles,connections) {
      var connectedPorts = function () {
         var _p58 = $List.unzip(connections);
         var ports1 = _p58._0;
         var ports2 = _p58._1;
         return $Set.toList(A2($Set.union,$Set.fromList(ports1),$Set.fromList(ports2)));
      }();
      var _p59 = A2($List.partition,function (_p60) {    return A2(F2(function (x,y) {    return _U.eq(x,y);}),$Types.Lamp,$Basics.snd(_p60));},tiles);
      var lamps = _p59._0;
      var others = _p59._1;
      var _p61 = A2($List.partition,function (_p62) {    return A2(F2(function (x,y) {    return _U.eq(x,y);}),$Types.Power,$Basics.snd(_p62));},others);
      var powers = _p61._0;
      var contacts = _p61._1;
      var connections$ = A2($Basics._op["++"],
      connections,
      A2($List.filterMap,
      function (_p63) {
         var _p64 = _p63;
         ...
         function (_p65) {
            var _p66 = _p65;
            return {ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: _p67,_1: _p66._0},_1: {ctor: "_Tuple2",_0: _p67,_1: _p66._1}};
         },
         inner(_p64._1));
      },
      contacts));
      var illegal = A3(isIllegal,powers,connections$,connectedPorts);
      return {ctor: "_Tuple2"
             ,_0: illegal
             ,_1: illegal || $List.isEmpty(connections) ? A2($List.map,
             function (_p68) {
                var _p69 = _p68;
                return {ctor: "_Tuple2",_0: _p69._0,_1: false};
             },
             lamps) : A4(onLamps,
             lamps,
             powers,
             ...
             function (_p70) {
                var _p71 = _p70;
                return A2($List.map,F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};})(_p71._0),ports(_p71._1));
             },
             tiles))};
   });
   return _elm.Logic.values = {_op: _op,process: process};
};
Elm.Drag = Elm.Drag || {};
...
Elm.Wiring = Elm.Wiring || {};
Elm.Wiring.make = function (_elm) {
   "use strict";
   _elm.Wiring = _elm.Wiring || {};
   if (_elm.Wiring.values) return _elm.Wiring.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Catalog = Elm.Catalog.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Util = Elm.Util.make(_elm);
   var _op = {};
   var normalizedWiring$$ = F3(function (_p1,_p0,info2) {
      var _p2 = _p1;
      var _p17 = _p2;
      var _p16 = _p2.right;
      var _p15 = _p2.left;
      ...
      var _p14 = _p3._1;
      var _p13 = _p3._0;
      var _p6 = A2($Maybe.map,function (_p4) {    var _p5 = _p4;return {ctor: "_Tuple2",_0: _p5.orientation,_1: _p5.spans};},info2);
      if (_p6.ctor === "Nothing") {
            return _U.cmp(_p13,$Catalog.portDistance) > 0 ? _U.list([_U.list([{ctor: "_Tuple2",_0: $Catalog.portDistance,_1: 0}
                                                                             ,{ctor: "_Tuple2",_0: $Catalog.portDistance,_1: _p14}])
                                                                    ,_U.list([{ctor: "_Tuple2",_0: _p13,_1: 0}])]) : _U.cmp(_p13,
            0) > 0 ? _U.list([_U.list([{ctor: "_Tuple2",_0: _p13,_1: 0}])]) : _U.cmp(_p14,_p15) > 0 ? _U.list([_U.list([{ctor: "_Tuple2"
                                                                                                                        ,_0: $Catalog.portDistance
                                                                                                                        ,_1: 0}
                                                                                                                       ,{ctor: "_Tuple2"
                                                                                                                        ,_0: $Catalog.portDistance
                                                                                                                        ,_1: _p15}
                                                                                                                       ,{ctor: "_Tuple2",_0: _p13,_1: _p15}])
                                                                                                              ,_U.list([{ctor: "_Tuple2"
                                                                                                                       ...
                                                                                                                       ,{ctor: "_Tuple2"
                                                                                                                        ,_0: $Catalog.portDistance
                                                                                                                        ,_1: _p14}])]) : _U.cmp(_p13,
            0 - $Catalog.portDistance) < 0 ? _U.list([_U.list([{ctor: "_Tuple2",_0: $Catalog.portDistance,_1: 0}
                                                              ,{ctor: "_Tuple2",_0: $Catalog.portDistance,_1: _p15}
                                                              ,{ctor: "_Tuple2",_0: _p13,_1: _p15}])]) : _U.list([_U.list([{ctor: "_Tuple2",_0: 0,_1: _p14}])]);
         } else {
            switch (_p6._0._0)
            {case 3: var y$ = _p14 - $Catalog.portDistance;
                 return _U.cmp(y$,_p15) > 0 || _U.cmp(_p13,$Catalog.portDistance) > 0 && _U.cmp(y$,0) > 0 ? A2($List.map,
                 A2($Basics.flip,F2(function (x,y) {    return A2($Basics._op["++"],x,y);}),_U.list([{ctor: "_Tuple2",_0: _p13,_1: y$}])),
                 A3(normalizedWiring$$,_p17,{ctor: "_Tuple2",_0: _p13,_1: y$},$Maybe.Nothing)) : _U.cmp(_p13,0) > 0 ? _U.list([_U.list([{ctor: "_Tuple2"
                                                                                                                                        ,_0: _p13
                                                                                                                                        ,_1: 0}])]) : _U.cmp(_p13,
                 0 - $Catalog.portDistance) < 0 ? _U.list([_U.list([{ctor: "_Tuple2",_0: $Catalog.portDistance,_1: 0}
                                                                   ,{ctor: "_Tuple2",_0: $Catalog.portDistance,_1: 0 - _p16}
                                                                   ,{ctor: "_Tuple2",_0: _p13,_1: 0 - _p16}])]) : _U.list([_U.list([{ctor: "_Tuple2"
                                                                                                                                    ,_0: 0
                                                                                                                                    ,_1: _p14}])]);
               case 1: var _p10 = _p6._0._1;
                 if (_U.cmp(_p13,0) > 0) return A2($List.map,
                    function (_p7) {
                       return $List.reverse(A2($List.map,function (_p8) {    var _p9 = _p8;return {ctor: "_Tuple2",_0: _p13 - _p9._1,_1: _p9._0 + _p14};},_p7));
                    },
                    A3(normalizedWiring$$,_p10,{ctor: "_Tuple2",_0: 0 - _p14,_1: _p13},$Maybe.Just(A2($Types.PortInfo,3,_p17)))); else {
                       var x$ = _p13 + _p10.right;
                       var y$ = _p14 + $Catalog.portDistance;
                       if (_U.cmp(x$,$Catalog.portDistance) > 0) return _U.list([_U.list([{ctor: "_Tuple2",_0: x$,_1: 0}
                                                                                         ,{ctor: "_Tuple2",_0: x$,_1: y$}
                                                                                         ,{ctor: "_Tuple2",_0: _p13,_1: y$}])]); else {
                             var y$$ = A2($Basics.max,y$,_p15);
                             return _U.list([_U.list([{ctor: "_Tuple2",_0: $Catalog.portDistance,_1: 0}
                                                     ,{ctor: "_Tuple2",_0: $Catalog.portDistance,_1: y$$}
                                                     ,{ctor: "_Tuple2",_0: _p13,_1: y$$}])
                                            ,_U.list([{ctor: "_Tuple2",_0: $Catalog.portDistance,_1: 0}
                                                     ,{ctor: "_Tuple2",_0: $Catalog.portDistance,_1: _p15}
                                                     ,{ctor: "_Tuple2",_0: x$,_1: _p15}
                                                     ,{ctor: "_Tuple2",_0: x$,_1: y$$}
                                                     ,{ctor: "_Tuple2",_0: _p13,_1: y$$}])]);
                          }
                    }
               case 2: var _p12 = _p6._0._1;
                 var x$ = _p13 - $Catalog.portDistance;
                 if (_U.cmp(x$,$Catalog.portDistance) > 0) return _U.list([_U.list([{ctor: "_Tuple2",_0: $Catalog.portDistance,_1: 0}
                                                                                   ,{ctor: "_Tuple2",_0: $Catalog.portDistance,_1: _p14}])
                                                                          ,_U.list([{ctor: "_Tuple2",_0: x$,_1: 0},{ctor: "_Tuple2",_0: x$,_1: _p14}])]);
                 else if (_U.cmp(_p13,0) > 0) {
                          var x$$ = _p13 / 2;
                          return _U.list([_U.list([{ctor: "_Tuple2",_0: x$$,_1: 0},{ctor: "_Tuple2",_0: x$$,_1: _p14}])]);
                       } else {
                          var y$ = _p14 - _p12.left;
                          var _p11 = _U.cmp(y$,_p15) > 0 ? {ctor: "_Tuple2",_0: _p15,_1: y$} : {ctor: "_Tuple2"
                                                                                               ,_0: A2($Basics.min,0 - _p16,y$)
                                                                                               ,_1: A2($Basics.max,_p15,_p14 + _p12.right)};
                          var y1 = _p11._0;
                          var y2 = _p11._1;
                          return _U.list([_U.list([{ctor: "_Tuple2",_0: $Catalog.portDistance,_1: 0}
                                                  ,{ctor: "_Tuple2",_0: $Catalog.portDistance,_1: y1}
                                                  ,{ctor: "_Tuple2",_0: x$,_1: y1}
                                                  ,{ctor: "_Tuple2",_0: x$,_1: _p14}])
                                         ,_U.list([{ctor: "_Tuple2",_0: $Catalog.portDistance,_1: 0}
                                                  ,{ctor: "_Tuple2",_0: $Catalog.portDistance,_1: y2}
                                                  ,{ctor: "_Tuple2",_0: x$,_1: y2}
                                                  ,{ctor: "_Tuple2",_0: x$,_1: _p14}])]);
                       }
               default: var x$ = _p13 + $Catalog.portDistance;
                 return _U.cmp(x$,0) > 0 || _U.cmp(_p14,_p15) > 0 ? _U.list([_U.list([{ctor: "_Tuple2",_0: $Catalog.portDistance,_1: 0}
                                                                                     ,{ctor: "_Tuple2"
                                                                                      ,_0: $Catalog.portDistance
                                                                                      ,_1: _p14}])]) : _U.list([_U.list([{ctor: "_Tuple2"
                                                                                                                         ,_0: $Catalog.portDistance
                                                                                                                         ,_1: 0}
                                                                                                                        ,{ctor: "_Tuple2"
                                                                                                                         ,_0: $Catalog.portDistance
                                                                                                               ...
                                                                                                               ,_U.list([{ctor: "_Tuple2"
                                                                                                                        ...
                                                                                                                        ,{ctor: "_Tuple2"
                                                                                                                         ,_0: $Catalog.portDistance
                                                                                                                         ,_1: 0 - _p16}
                                                                                                                        ,{ctor: "_Tuple2",_0: x$,_1: 0 - _p16}
                                                                                                                        ,{ctor: "_Tuple2",_0: x$,_1: _p14}])]);}
         }
   });
   var swap = function (_p18) {    var _p19 = _p18;return {left: _p19.right,right: _p19.left};};
   var normalizedWiring$ = F3(function (spans1,_p20,info2) {
      var _p21 = _p20;
      var _p26 = _p21._1;
      return _U.cmp(_p26,0) < 0 ? A2($List.map,
      $List.map(function (_p22) {    var _p23 = _p22;return {ctor: "_Tuple2",_0: _p23._0,_1: 0 - _p23._1};}),
      A3(normalizedWiring$$,
      swap(spans1),
      {ctor: "_Tuple2",_0: _p21._0,_1: 0 - _p26},
      A2($Maybe.map,function (_p24) {    var _p25 = _p24;return A2($Types.PortInfo,4 - _p25.orientation,swap(_p25.spans));},info2))) : A3(normalizedWiring$$,
      spans1,
      _p21,
      info2);
   });
   var normalizedWiring = F3(function (spans1,_p27,info2) {
      var _p28 = _p27;
      var _p32 = _p28._0;
      var _p31 = _p28;
      var _p29 = info2;
      if (_p29.ctor === "Nothing") {
            return A3(normalizedWiring$,spans1,_p31,info2);
         } else {
            return _U.eq(_p29._0.orientation,0) && _U.cmp(_p32,0) > 0 ? A2($List.map,
            function (_p30) {
               return $List.reverse(A2($List.map,$Util.plus(_p31),_p30));
            },
            A3(normalizedWiring$,
            _p29._0.spans,
            {ctor: "_Tuple2",_0: 0 - _p32,_1: 0 - _p28._1},
            $Maybe.Just(A2($Types.PortInfo,0,spans1)))) : A3(normalizedWiring$,spans1,_p31,info2);
         }
   });
   var wiringChoices = F2(function (_p34,_p33) {
      var _p35 = _p34;
      var _p38 = _p35._1.orientation;
      var _p36 = _p33;
      var orientation$ = 4 - _p38;
      var from$ = A2($Util.rotate,orientation$,_p35._0);
      var to$ = A2($Util.rotate,orientation$,_p36._0);
      var info$ = A2($Maybe.map,function (info) {    return _U.update(info,{orientation: A2($Basics._op["%"],info.orientation + orientation$,4)});},_p36._1);
      return A2($List.map,
      $List.map(function (_p37) {    return A2($Util.rotate,_p38,A2($Util.plus,from$,_p37));}),
      A3(normalizedWiring,_p35._1.spans,A2($Util.minus,to$,from$),info$));
   });
   var fromTo = F3(function (from,to,_p39) {
      var _p40 = _p39;
      var delta = function (_p41) {    var _p42 = _p41;return $Basics.abs(_p42._0._0 - _p42._1._0 + _p42._0._1 - _p42._1._1);};
      var weight = function (ps) {
         var l = $List.length(ps);
         return $List.sum(A2($List.map,
         function (_p43) {
            var _p44 = _p43;
            var dy = _p44._1 - _p40._1;
            var dx = _p44._0 - _p40._0;
            return dx * dx + dy * dy;
         },
         ps)) / $Basics.toFloat(l * l);
      };
      var pairs = function (ps) {    return A2($List$Extra.zip,ps,A2($Maybe.withDefault,_U.list([]),$List.tail(ps)));};
      var removeDups = function (ps) {
         var _p45 = $List.head(ps);
         if (_p45.ctor === "Nothing") {
               ...
               function (_p46) {
                  var _p47 = _p46;
                  var _p48 = _p47._1;
                  return !_U.eq(_p47._0,_p48) ? $Maybe.Just(_p48) : $Maybe.Nothing;
               },
               pairs(ps)));
            }
      };
      var goodness = function (ps) {
         var w = weight(ps);
         return A2($List.any,
         function (_p49) {
            return A2(F2(function (x,y) {    return _U.cmp(x,y) > 0;}),$Catalog.portDistance,delta(_p49));
         },
         pairs(ps)) ? 0.5 * w : w;
      };
      ...
      _U.list([$Basics.fst(to)]),
      A2($Maybe.withDefault,_U.list([]),A2($List$Extra.maximumBy,goodness,A2($List.map,removeDups,A2(wiringChoices,from,to))))));
   });
   return _elm.Wiring.values = {_op: _op,fromTo: fromTo};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $Types = Elm.Types.make(_elm),
   $Util = Elm.Util.make(_elm),
   $Wiring = Elm.Wiring.make(_elm);
   var _op = {};
   var updateLogic = function (_p0) {
      var _p1 = _p0;
      var _p7 = _p1.tiles;
      var tileStates = A2($List.map,
      function (_p2) {
         var _p3 = _p2;
         return {ctor: "_Tuple2",_0: _p3._0,_1: A2($Util.applyStatus,_p3._1.component.logic,_p3._1.status)};
      },
      $Dict.toList(_p7));
      var _p4 = A2($Logic.process,tileStates,_p1.connections);
      var illegal = _p4._0;
      var toActivate = _p4._1;
      return _U.update(_p1,
      {tiles: A3($List.foldl,
      function (_p5) {
         var _p6 = _p5;
         return A2($Dict.update,_p6._0,$Maybe.map(function (tile) {    return _U.update(tile,{status: $Types.Active(_p6._1)});}));
      },
      _p7,
      toActivate)
      ,illegal: illegal});
   ...
   var Mouse = function (a) {    return {ctor: "Mouse",_0: a};};
   var Connect = function (a) {    return {ctor: "Connect",_0: a};};
   var Turn = function (a) {    return {ctor: "Turn",_0: a};};
   var Create = function (a) {    return {ctor: "Create",_0: a};};
   var DnD = function (a) {    return {ctor: "DnD",_0: a};};
   var Model = F9(function (a,b,c,d,e,f,g,h,i) {
      return {nextTile: a,tiles: b,toggles: c,connections: d,turnBlocked: e,picked: f,inConnect: g,mouse: h,illegal: i};
   });
   var noEffects = A2($Basics.flip,F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),$Effects.none);
   var init = noEffects({nextTile: 0
                        ,tiles: $Dict.empty
                        ,toggles: $Array.empty
                        ,connections: _U.list([])
                        ,turnBlocked: false
                        ,picked: $Maybe.Nothing
                        ,inConnect: $Maybe.Nothing
                        ,mouse: {ctor: "_Tuple2",_0: 0,_1: 0}
                        ,illegal: false});
   var update = F2(function (action,_p8) {
      var _p9 = _p8;
      var _p35 = _p9.toggles;
      var _p34 = _p9.tiles;
      var _p33 = _p9.nextTile;
      var _p32 = _p9;
      var _p31 = _p9.inConnect;
      var _p30 = _p9.connections;
      return noEffects(function () {
         var _p10 = action;
         switch (_p10.ctor)
         {case "DnD": if (_p10._0.ctor === "Nothing") {
                    return _p32;
                 } else {
                    switch (_p10._0._0._1.ctor)
                    {case "Lift": return _U.update(_p32,{turnBlocked: false,picked: $Maybe.Just(_p10._0._0._0)});
                       case "MoveBy": return _U.update(_p32,
                         {turnBlocked: true
                         ,tiles: A3($Dict.update,
                         _p10._0._0._0,
                         $Maybe.map(function (tile) {
                            return _U.update(tile,
                            {pos: A2($Util.plus,
                            tile.pos,
                            {ctor: "_Tuple2",_0: $Basics.toFloat(_p10._0._0._1._0._0),_1: $Basics.toFloat(0 - _p10._0._0._1._0._1)})});
                         }),
                         _p34)});
                       default: return _U.update(_p32,
                         {picked: $Maybe.Nothing
                         ,tiles: A3($Dict.update,
                         _p10._0._0._0,
                         $Maybe.map(function (tile) {
                            ...
                            {pos: function () {
                               var _p11 = tile.pos;
                               return {ctor: "_Tuple2",_0: $Util.snap(_p11._0),_1: $Util.snap(_p11._1)};
                            }()});
                         }),
                         _p34)});}
                 }
            case "Create": var _p15 = _p10._0._1;
              var _p14 = _p10._0._2;
              var _p13 = _p10._0._0;
              var _p12 = _p10._0._3;
              if (_p12.ctor === "Just") {
                    return _U.update(_p32,
                    {nextTile: _p33 + 1
                    ,tiles: A3($Dict.insert,_p33,A5($Types.Tile,_p13,0,_p14,_p15,$Maybe.Just($Array.length(_p35))),_p34)
                    ,toggles: A2($Array.push,{ctor: "_Tuple2",_0: _p33,_1: _p12._0},_p35)});
                 } else {
                    return _U.update(_p32,{nextTile: _p33 + 1,tiles: A3($Dict.insert,_p33,A5($Types.Tile,_p13,0,_p14,_p15,$Maybe.Nothing),_p34)});
                 }
            case "Turn": return _p9.turnBlocked ? _p32 : _U.update(_p32,
              {tiles: A3($Dict.update,
              _p10._0,
              $Maybe.map(function (tile) {    return _U.update(tile,{orientation: A2($Basics._op["%"],tile.orientation + 1,4)});}),
              _p34)});
            case "Connect": var _p18 = _p10._0;
              var _p16 = _p31;
              if (_p16.ctor === "Nothing") {
                    return _U.update(_p32,{inConnect: $Maybe.Just(_p18)});
                 } else {
                    var _p17 = _p16._0;
                    return _U.eq(_p17,_p18) ? _U.update(_p32,{inConnect: $Maybe.Nothing}) : updateLogic(_U.update(_p32,
                    {inConnect: $Maybe.Nothing,connections: A2($List._op["::"],{ctor: "_Tuple2",_0: _p17,_1: _p18},_p30)}));
                 }
            case "Mouse": return _U.update(_p32,{mouse: _p10._0});
            case "Delete": var _p19 = _p9.picked;
              if (_p19.ctor === "Nothing") {
                    return _U.update(_p32,{inConnect: $Maybe.Nothing});
                 } else {
                    var _p23 = _p19._0;
                    return A2($Util.isConnected,_p23,_p30) ? updateLogic(_U.update(_p32,
                    {turnBlocked: true
                    ,connections: A2($List.filter,
                    function (_p20) {
                       var _p21 = _p20;
                       return !_U.eq(_p21._0._0,_p23) && !_U.eq(_p21._1._0,_p23);
                    },
                    _p30)})) : _U.update(_p32,
                    {picked: $Maybe.Nothing
                    ,tiles: A2($Dict.remove,_p23,_p34)
                    ,inConnect: function () {
                       var _p22 = _p31;
                       if (_p22.ctor === "Nothing") {
                             return $Maybe.Nothing;
                          } else {
                             return _U.eq(_p22._0._0,_p23) ? $Maybe.Nothing : _p31;
                          }
                    }()});
                 }
            default: var _p29 = _p10._0._1;
              var _p24 = A2($Array.get,_p10._0._0,_p35);
              if (_p24.ctor === "Nothing") {
                    return _p32;
                 } else {
                    var _p28 = _p24._0._1;
                    var _p27 = _p24._0._0;
                    return _p29 && _p28 || $Basics.not(_p28) && A3($Maybe$Extra.mapDefault,
                    false,
                    function (_p25) {
                       var _p26 = _p25;
                       return !_U.eq(_p26.status,$Types.Active(_p29));
                    },
                    A2($Dict.get,_p27,_p34)) ? updateLogic(_U.update(_p32,
                    {tiles: A3($Dict.update,
                    _p27,
                    $Maybe.map(function (tile) {    return _U.update(tile,{status: $Util.switchStatus(tile.status)});}),
                    _p34)})) : _p32;
                 }}
      }());
   });
   var yExtent = Elm.Native.Port.make(_elm).inbound("yExtent",
   "Int",
   function (v) {
      return typeof v === "number" && isFinite(v) && Math.floor(v) === v ? v : _U.badPort("an integer",v);
   });
   var xExtent = Elm.Native.Port.make(_elm).inbound("xExtent",
   "Int",
   function (v) {
      return typeof v === "number" && isFinite(v) && Math.floor(v) === v ? v : _U.badPort("an integer",v);
   });
   var _p36 = A2($Draw.makeGround,$Basics.toFloat(xExtent),$Basics.toFloat(yExtent));
   var redFlag = _p36._0;
   var arena = _p36._1;
   var view = F2(function (address,_p37) {
      ...
      var _p59 = _p38.tiles;
      var _p58 = _p38.mouse;
      var _p57 = _p38.connections;
      var average = function (ps) {
         var n = $Basics.toFloat($List.length(ps));
         var _p39 = $List.unzip(ps);
         var xs = _p39._0;
         var ys = _p39._1;
         return {ctor: "_Tuple2",_0: $List.sum(xs) / n,_1: $List.sum(ys) / n};
      };
      var center = average(A2($List.filterMap,
      function (_p40) {
         var _p41 = _p40;
         return A2($Util.isConnected,_p41._0,_p57) ? $Maybe.Just(_p41._1.pos) : $Maybe.Nothing;
      },
      $Dict.toList(_p59)));
      var portInfo = function (_p42) {
         var _p43 = _p42;
         var _p44 = A2($Dict.get,_p43._0,_p59);
         if (_p44.ctor === "Nothing") {
               return _U.crashCase("Main",{start: {line: 79,column: 13},end: {line: 93,column: 58}},_p44)("IMPOSSIBLE!");
            } else {
               var _p52 = _p44._0.orientation;
               var _p46 = _p44._0.component.viewInfo;
               var ports = _p46.ports;
               var _p50 = A2($Maybe.map,
               function (_p47) {
                  var _p48 = _p47;
                  var _p49 = _p48._1;
                  return {ctor: "_Tuple2",_0: A2($Util.rotate,_p52,_p48._0),_1: _U.update(_p49,{orientation: A2($Basics._op["%"],_p49.orientation + _p52,4)})};
               },
               A2($List$Extra.getAt,ports,_p43._1));
               if (_p50.ctor === "Nothing") {
                     return _U.crashCase("Main",{start: {line: 88,column: 25},end: {line: 93,column: 58}},_p50)("IMPOSSIBLE!");
                  } else {
                     return {ctor: "_Tuple2",_0: A2($Util.plus,_p44._0.pos,_p50._0._0),_1: _p50._0._1};
                  }
            }
      };
      ...
      2 * xExtent,
      2 * yExtent,
      (_p38.illegal ? F2(function (x,y) {    return A2($Basics._op["++"],x,y);})(redFlag) : $Basics.identity)(function () {
         var _p53 = _p38.inConnect;
         if (_p53.ctor === "Nothing") {
               return $Basics.identity;
            } else {
               return F2(function (x,y) {    return A2($List._op["::"],x,y);})(A2($Graphics$Collage.traced,
               _U.update($Graphics$Collage.defaultLine,{width: 2}),
               $Graphics$Collage.path(A3($Wiring.fromTo,portInfo(_p53._0),{ctor: "_Tuple2",_0: _p58,_1: $Maybe.Nothing},center))));
            }
      ...
      function (_p54) {
         ...
         _U.update($Graphics$Collage.defaultLine,{width: 2}),
         $Graphics$Collage.path(A3($Wiring.fromTo,
         portInfo(_p55._0),
         function () {
            var _p56 = portInfo(_p55._1);
            return {ctor: "_Tuple2",_0: _p56._0,_1: $Maybe.Just(_p56._1)};
         }(),
         center)));
      },
      _p57),
      $Pictures.picturesToForms(A3($List.foldr,
      $Pictures.join,
      arena,
      A2($List.map,A3($Draw.tile,A2($Signal.forwardTo,address,Turn),A2($Signal.forwardTo,address,Connect),_p58),$Dict.toList(_p59)))))))));
   });
   var app = $StartApp.start({init: init
                             ,view: view
                             ,update: update
                             ,inputs: _U.list([A2($Signal.map,DnD,A2($Drag.trackMany,$Maybe.Nothing,$Inputs.hover.signal))
                                              ,A2($Signal.map,Create,$Inputs.create.signal)
                                              ,A2($Signal.map,
                                              function (_p60) {
                                                 var _p61 = _p60;
                                                 return Mouse({ctor: "_Tuple2",_0: $Basics.toFloat(_p61._0 - xExtent),_1: $Basics.toFloat(yExtent - _p61._1)});
                                              },
                                              A2($Time.delay,0,$Mouse.position))
                                              ,A2($Signal.map,
                                              $Basics.always(Delete),
                                              A3($Signal.filter,A2($Basics.flip,$List.member,_U.list([46,120])),0,$Keyboard.presses))
                                              ,A2($Signal.map,Toggle,$Inputs.toggling)])});
   var main = app.html;
